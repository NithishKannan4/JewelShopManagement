...
public class ManagerAdd {
    ...
    ManagerAdd() {
        ...
        title = new JLabel("Add Manager Details");
        title.setFont(f1);
    ...
    void add(String name1,String fname1,String add1,String city1,String pin1,String mob1,String pan1,String pass1) {
        try {
            ...
            String id = "MA00" + (++Main.manager_count);
            int salary = 60000;
            String query = "insert into Manager(ID,name,fname,address,city,pin,mobile,password,pan,salary) values ('" + id + "','" + name1 + "','" + fname1 + "','" + add1 + "','" +
